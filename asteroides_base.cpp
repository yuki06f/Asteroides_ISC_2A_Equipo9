...
void moverAsteroides(Asteroide*, int);
...
int main(){
	...
	ALLEGRO_BITMAP* nave = al_load_bitmap("img/nave.png"); //imagen de la nave
	ALLEGRO_BITMAP* asteroide = al_load_bitmap("C:\\Users\\ferhd\\OneDrive\\Escritorio\\Asteroides\\img\\asteroide.png");
	if (!asteroide) {
